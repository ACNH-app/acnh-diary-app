...
const styles = StyleSheet.create({
  ...
  backdropPressable: { backgroundColor: 'rgba(70, 84, 89, 0.28)', bottom: 0, left: 0, position: 'absolute', right: 0, top: 0, zIndex: 0 },
  drawer: { backgroundColor: AppColors.background, borderBottomLeftRadius: 28, borderTopLeftRadius: 28, bottom: 0, elevation: 12, overflow: 'hidden', position: 'absolute', right: 0, shadowColor: AppColors.primaryBorder, shadowOffset: { height: 0, width: -4 }, shadowOpacity: 0.22, shadowRadius: 12, top: 0, zIndex: 1 },
  drawerContent: { flex: 1, paddingHorizontal: 21 },
  drawerHeader: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' },
  drawerKicker: { color: AppColors.primaryText, fontSize: 10, fontWeight: '800', letterSpacing: 1.5 },
  closeButton: { alignItems: 'center', height: 40, justifyContent: 'center', width: 40 },
  closeText: { color: AppColors.primaryText, fontSize: 28 },
  drawerTitle: { color: AppColors.primaryText, fontSize: 27, fontWeight: '800', marginTop: 9 },
  passportCard: { backgroundColor: AppColors.primarySoft, borderRadius: 19, marginTop: 17, padding: 17 },
  passportLabel: { color: AppColors.primaryText, fontSize: 10, marginTop: 7 },
  passportValue: { color: AppColors.primaryText, fontSize: 14, fontWeight: '800', marginTop: 3 },
  ...
  drawerActionText: { color: AppColors.primaryText, fontSize: 12, fontWeight: '800' },
  drawerMuted: { color: '#687A80', fontSize: 12, fontWeight: '700' },
  ...
  rowArrow: { color: '#82959A', fontSize: 21 },
});

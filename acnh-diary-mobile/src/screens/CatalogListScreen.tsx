...
const styles = StyleSheet.create({
  ...
  itemName: { color: AppColors.ink, fontSize: 18, fontWeight: '800', lineHeight: 23, marginTop: 4 },
  itemClassification: { color: AppColors.ink, fontSize: 11, fontWeight: '800' },
  ...
  detailLabel: { color: AppColors.inkMuted, flexShrink: 0, fontSize: 11, fontWeight: '700', lineHeight: 16, marginRight: 8, width: 52 },
  tagText: { color: AppColors.inkMuted, flex: 1, fontSize: 10, fontWeight: '700', lineHeight: 15 },
  acquisitionDetails: { flex: 1, minWidth: 0 },
  acquisitionText: { color: AppColors.ink, fontSize: 11, fontWeight: '700', lineHeight: 16 },
  itemMaterials: { color: '#9B8060', fontSize: 10, lineHeight: 14, marginTop: 4 },
  nonSaleChip: { alignSelf: 'flex-start', backgroundColor: AppColors.residentSoft, borderRadius: AppRadii.pill, marginTop: 6, paddingHorizontal: 10, paddingVertical: 7 },
  nonSaleText: { color: AppColors.danger, fontSize: 11, fontWeight: '800' },
  statusButton: { alignItems: 'center', justifyContent: 'flex-start', marginLeft: 7, paddingTop: 2, width: AppControlSizes.compactStatusMax },
  statusText: { color: AppColors.inkMuted, fontSize: 9, fontWeight: '800', marginBottom: 4 },
  statusTextActive: { color: AppColors.ink },
  statusCircle: { alignItems: 'center', backgroundColor: AppColors.card, borderColor: AppColors.line, borderRadius: AppRadii.pill, borderWidth: 1.6, height: AppControlSizes.compactStatus, justifyContent: 'center', width: AppControlSizes.compactStatus },
  statusCircleActive: { backgroundColor: AppColors.catalogSoft, borderColor: AppColors.catalog },
  statusCheck: { color: AppColors.catalog, fontSize: 20, fontWeight: '800', lineHeight: 22 },

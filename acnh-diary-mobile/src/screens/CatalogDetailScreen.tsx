...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#29382C', fontSize: 28, fontWeight: '800', marginTop: 3 },
  ...
  heroCopy: { flex: 1 },
  itemName: { color: '#2E4032', fontSize: 21, fontWeight: '800', lineHeight: 28 },
  itemEnglish: { color: '#8B978D', fontSize: 12, marginTop: 4 },
  itemCategory: { color: '#4C7654', fontSize: 12, fontWeight: '800', marginTop: 12 },
  ownedPanel: { alignItems: 'center', backgroundColor: '#E9EEE7', borderColor: '#D7E3D4', borderRadius: 16, borderWidth: 1, flexDirection: 'row', marginTop: 14, paddingHorizontal: 16, paddingVertical: 13 },
  ownedPanelActive: { backgroundColor: '#DCEED8', borderColor: '#BFD8BE' },
  ownedCopy: { flex: 1, marginLeft: 12 },
  panelEyebrow: { color: '#718275', fontSize: 10, fontWeight: '800', letterSpacing: 0.8 },
  panelTitle: { color: '#36553D', fontSize: 16, fontWeight: '800', marginTop: 3 },
  panelAction: { color: '#3F724B', fontSize: 11, fontWeight: '800' },
  section: { marginTop: 20 },
  sectionTitle: { color: '#526A57', fontSize: 15, fontWeight: '800', marginBottom: 8 },
  ...
  variantOwnedButton: { alignItems: 'center', backgroundColor: '#E9EEE7', borderRadius: 8, flexDirection: 'row', marginTop: 6, paddingHorizontal: 6, paddingVertical: 4 },
  variantOwnedButtonActive: { backgroundColor: '#DCEED8' },
  variantOwnedText: { color: '#5E7562', fontSize: 9, fontWeight: '800', marginLeft: 4 },
  quantityRow: { alignItems: 'center', flexDirection: 'row', marginTop: 5 },
  quantityButton: { alignItems: 'center', backgroundColor: '#E2EAE0', borderRadius: 7, height: 22, justifyContent: 'center', width: 22 },
  quantityButtonText: { color: '#4C7152', fontSize: 15, fontWeight: '800', lineHeight: 17 },
  quantityText: { color: '#4B604F', fontSize: 10, fontWeight: '800', minWidth: 24, textAlign: 'center' },

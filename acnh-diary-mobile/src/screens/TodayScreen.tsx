...
const styles = StyleSheet.create({
  screenRoot: { flex: 1 }, safeArea: { backgroundColor: AppColors.background, flex: 1 }, content: { padding: 20, paddingBottom: 112 }, headerRow: { alignItems: 'flex-start', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 }, kicker: { color: AppColors.primaryText, fontSize: 10, fontWeight: '800', letterSpacing: 1.8 }, title: { color: AppColors.primaryText, fontSize: 36, fontWeight: '800', marginTop: 4 }, date: { color: '#788077', fontSize: 13, marginTop: 4 }, menuButton: { alignItems: 'center', backgroundColor: AppColors.primarySurface, borderRadius: 20, height: 44, justifyContent: 'center', width: 44 }, menuText: { color: AppColors.primaryText, fontSize: 22 }, islandCard: { backgroundColor: AppColors.primarySoft, borderRadius: 24, padding: 20 }, cardEyebrow: { color: AppColors.primaryText, fontSize: 10, fontWeight: '800', letterSpacing: 1.3 }, islandName: { color: AppColors.primaryText, fontSize: 27, fontWeight: '800', marginTop: 5 }, islandRule: { backgroundColor: AppColors.primaryBorder, height: 1, marginVertical: 16 }, profileText: { color: AppColors.primaryText, fontSize: 12, fontWeight: '700' }, summaryCard: { backgroundColor: '#FFF', borderColor: '#DDE8D8', borderRadius: 18, borderWidth: 1, padding: 14 }, summaryHeader: { alignItems: 'center', flexDirection: 'row', gap: 10, justifyContent: 'space-between' }, summaryCopy: { borderRadius: 12, flex: 1, minWidth: 0, padding: 2 }, summaryDatePressed: { backgroundColor: '#F6F9F3' }, summaryLabel: { color: '#7E8E7F', fontSize: 10, fontWeight: '800' }, summaryTitle: { color: AppColors.primaryText, fontSize: 20, fontWeight: '800', marginTop: 3 }, summaryMeta: { color: '#819082', fontSize: 10, marginTop: 4 }, summaryGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 13 }, summaryItem: { backgroundColor: '#F6F9F3', borderColor: '#E5ECE1', borderRadius: 12, borderWidth: 1, minHeight: 74, padding: 10, width: '48%' }, summaryItemLabel: { color: '#778677', fontSize: 10, fontWeight: '800', marginBottom: 5 }, summaryItemValue: { color: AppColors.primaryText, fontSize: 12, fontWeight: '800', lineHeight: 17 }, eventStrip: { alignItems: 'center', backgroundColor: AppColors.primarySoft, borderRadius: 12, flexDirection: 'row', gap: 10, marginTop: 10, padding: 10 }, eventLabel: { color: '#617166', fontSize: 10, fontWeight: '800' }, eventText: { color: AppColors.primaryText, flex: 1, fontSize: 12, fontWeight: '800' }, dateCard: { alignItems: 'center', backgroundColor: '#FFF', borderColor: '#E2E8DF', borderRadius: 18, borderWidth: 1, flexDirection: 'row', justifyContent: 'space-between', marginTop: 12, padding: 14 }, dateCopy: { flex: 1 }, dateHint: { color: '#89968B', fontSize: 10, marginTop: 4 }, dateActions: { alignItems: 'center', flexDirection: 'row', gap: 5 }, dateButton: { alignItems: 'center', backgroundColor: AppColors.primarySurface, borderRadius: 10, height: 30, justifyContent: 'center', width: 30 }, dateButtonText: { color: AppColors.primaryText, fontSize: 22, lineHeight: 25 }, todayButton: { backgroundColor: AppColors.primaryAction, borderRadius: 10, paddingHorizontal: 9, paddingVertical: 8 }, todayButtonText: { color: AppColors.primaryText, fontSize: 10, fontWeight: '800' }, sectionHeader: { alignItems: 'flex-end', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10, marginTop: 24 }, sectionHeaderCopy: { flex: 1 }, sectionTitle: { color: AppColors.primaryText, fontSize: 19, fontWeight: '800' }, sectionDescription: { color: '#8B938A', fontSize: 11, marginTop: 3 }, sectionAction: { color: AppColors.primaryText, fontSize: 11, fontWeight: '800', paddingBottom: 2 }, infoGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 9 }, infoTile: { alignItems: 'center', backgroundColor: '#FFF', borderColor: '#E4E9E0', borderRadius: 16, borderWidth: 1, flexDirection: 'row', minHeight: 70, padding: 12, width: '48%' }, infoIcon: { color: AppColors.primaryAction, fontSize: 22, marginRight: 9 }, infoLabel: { color: '#8A978D', fontSize: 10 }, infoValue: { color: AppColors.primaryText, fontSize: 13, fontWeight: '800', marginTop: 4 }, noticeCard: { backgroundColor: '#F0E9D9', borderRadius: 16, marginTop: 10, padding: 14 }, noticeTitle: { color: '#76583F', fontSize: 12, fontWeight: '800' }, noticeText: { color: '#9B795B', fontSize: 11, lineHeight: 17, marginTop: 4 }, tabRow: { gap: 8, paddingBottom: 10 }, tabChip: { backgroundColor: AppColors.primarySurface, borderRadius: 15, paddingHorizontal: 13, paddingVertical: 8 }, tabChipActive: { backgroundColor: AppColors.primary }, tabChipText: { color: '#68766B', fontSize: 12, fontWeight: '800' }, tabChipTextActive: { color: AppColors.primaryText }, critterList: { backgroundColor: '#FFF', borderColor: '#E2E8DF', borderRadius: 17, borderWidth: 1, overflow: 'hidden' }, critterRow: { alignItems: 'center', borderBottomColor: '#EDF1EB', borderBottomWidth: 1, flexDirection: 'row', minHeight: 78, padding: 9 }, critterImageFrame: { alignItems: 'center', backgroundColor: '#F5F8F2', borderRadius: 11, height: 58, justifyContent: 'center', width: 58 }, critterImage: { height: 52, width: 52 }, critterImageUncaught: { opacity: 0.35 }, critterCopy: { flex: 1, marginLeft: 10, minWidth: 0 }, critterName: { color: AppColors.primaryText, fontSize: 13, fontWeight: '800' }, critterMeta: { color: '#8B978D', fontSize: 10, marginTop: 5 }, critterStatus: { flexDirection: 'row', gap: 4 }, critterStatusButton: { alignItems: 'center', backgroundColor: AppColors.primarySurface, borderRadius: 10, height: 27, justifyContent: 'center', width: 27 }, noData: { color: '#8B978D', padding: 22, textAlign: 'center' }, routineCard: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, routineTile: { alignItems: 'center', backgroundColor: '#F6F9F3', borderColor: '#CFE0C8', borderRadius: 8, borderWidth: 1, justifyContent: 'center', minHeight: 58, overflow: 'hidden', paddingHorizontal: 5, paddingVertical: 8, position: 'relative', width: '23%' }, routineTileDimmed: { backgroundColor: '#EEF0EC', borderColor: '#E0E5DD', opacity: 0.45 }, routineTileComplete: { backgroundColor: AppColors.primaryAction, borderColor: AppColors.primaryBorder, opacity: 1 }, routineTileText: { color: AppColors.primaryText, fontSize: 10, fontWeight: '900', lineHeight: 13, textAlign: 'center' }, routineTileTextDimmed: { color: '#7E887D' }, routineTileTextComplete: { color: AppColors.primaryText }, routineCheckBadge: { alignItems: 'center', backgroundColor: '#FFF', borderRadius: 8, height: 16, justifyContent: 'center', position: 'absolute', right: 3, top: 3, width: 16 }, routineCheckText: { color: AppColors.primaryText, fontSize: 10, fontWeight: '900', lineHeight: 13 }, routineRow: { alignItems: 'center', flexDirection: 'row', minHeight: 66 }, routineDivider: { borderTopColor: '#EFF0EB', borderTopWidth: 1 }, routineIcon: { alignItems: 'center', backgroundColor: AppColors.primarySurface, borderRadius: 14, height: 35, justifyContent: 'center', marginRight: 11, width: 35 }, routineIconDone: { backgroundColor: AppColors.primaryAction }, routineIconText: { color: AppColors.primaryText, fontSize: 20, fontWeight: '800' }, routineIconTextDone: { color: AppColors.primaryText }, routineCopy: { flex: 1 }, routineTitle: { color: AppColors.primaryText, fontSize: 13, fontWeight: '800' }, routineTitleDone: { color: AppColors.primaryAction }, routineGoal: { color: '#9AA29A', fontSize: 10, marginTop: 4 }, smallAction: { color: AppColors.primaryText, fontSize: 10, fontWeight: '800', padding: 6 }, npcCard: { backgroundColor: '#FFF', borderColor: '#E2E8DF', borderRadius: 17, borderWidth: 1, flexDirection: 'row', padding: 7 }, npcDayCell: { alignItems: 'center', borderRadius: 12, flex: 1, minHeight: 126, minWidth: 0, paddingHorizontal: 2, paddingVertical: 8 }, npcDayCellToday: { backgroundColor: '#F6F9F3' }, npcWeekday: { color: '#829080', fontSize: 10, fontWeight: '800' }, npcDateNumber: { color: AppColors.primaryText, fontSize: 11, fontWeight: '800', marginTop: 3 }, npcAvatarStack: { alignContent: 'center', flexDirection: 'row', flexWrap: 'wrap', gap: 3, justifyContent: 'center', marginTop: 7, minHeight: 51 }, npcAvatar: { alignItems: 'center', backgroundColor: AppColors.primarySurface, borderRadius: 16, height: 32, justifyContent: 'center', width: 32 }, npcWeekAvatar: { borderRadius: 12, height: 24, width: 24 }, npcAvatarEmpty: { backgroundColor: '#F5F1E8', borderColor: '#E2D5C1', borderWidth: 1 }, npcAvatarSelected: { backgroundColor: AppColors.primaryAction }, npcAvatarText: { color: AppColors.primaryText, fontSize: 13, fontWeight: '800' }, npcName: { color: AppColors.primaryText, fontSize: 10, fontWeight: '800', lineHeight: 13, marginTop: 5, maxWidth: '100%', textAlign: 'center' }, npcNameEmpty: { color: '#9A907F' }, rowArrow: { color: '#82959A', fontSize: 21 }, calendarCard: { backgroundColor: '#FFF', borderColor: '#E2E8DF', borderRadius: 17, borderWidth: 1, paddingHorizontal: 10, paddingBottom: 12 }, calendarToggle: { backgroundColor: AppColors.primarySurface, borderRadius: 11, flexDirection: 'row', marginVertical: 12, padding: 3 }, calendarToggleButton: { alignItems: 'center', borderRadius: 8, flex: 1, paddingVertical: 7 }, calendarToggleActive: { backgroundColor: AppColors.primaryAction }, calendarToggleText: { color: '#7A8A7B', fontSize: 11, fontWeight: '800' }, calendarToggleTextActive: { color: AppColors.primaryText }, calendarPeriodTitle: { color: AppColors.primaryText, fontSize: 14, fontWeight: '900', marginBottom: 10, textAlign: 'center' }, calendarWeekdayRow: { borderBottomColor: '#EDF1EB', borderBottomWidth: 1, flexDirection: 'row', paddingBottom: 7 }, calendarWeekdayText: { color: '#7A8A7B', flex: 1, fontSize: 10, fontWeight: '800', textAlign: 'center' }, calendarBoard: { flexDirection: 'row', flexWrap: 'wrap' }, calendarDayCell: { borderBottomColor: '#EDF1EB', borderBottomWidth: 1, borderRightColor: '#EDF1EB', borderRightWidth: 1, minHeight: 78, padding: 4, width: '14.2857%' }, calendarWeekCell: { minHeight: 104 }, calendarDayCellEmpty: { backgroundColor: '#FAFBF8' }, calendarDayCellToday: { backgroundColor: '#F2F8ED' }, calendarDayNumber: { color: AppColors.primaryText, fontSize: 11, fontWeight: '800', marginBottom: 4, textAlign: 'center' }, calendarDayNumberToday: { color: '#386B45', fontWeight: '900' }, calendarItemStack: { gap: 3, minHeight: 40 }, calendarBadge: { borderRadius: 5, minHeight: 16, paddingHorizontal: 3, paddingVertical: 2 }, calendarBirthdayBadge: { backgroundColor: '#FFF0D8' }, calendarEventBadge: { backgroundColor: '#E8F2F5' }, calendarBadgeText: { fontSize: 8, fontWeight: '800', lineHeight: 11 }, calendarBirthdayText: { color: '#A26A2D' }, calendarEventText: { color: '#4D7480' }, calendarMoreText: { color: '#788077', fontSize: 8, fontWeight: '800', textAlign: 'center' }, calendarHeader: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, monthButton: { alignItems: 'center', backgroundColor: AppColors.primarySurface, borderRadius: 10, height: 34, justifyContent: 'center', width: 34 }, monthButtonText: { color: AppColors.primaryText, fontSize: 24, lineHeight: 28 }, monthTitle: { color: AppColors.primaryText, fontSize: 16, fontWeight: '800' }, weekdayRow: { flexDirection: 'row', marginTop: 14 }, weekdayText: { color: '#7A8A7B', flex: 1, fontSize: 10, fontWeight: '800', textAlign: 'center' }, calendarGrid: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 6 }, dayCell: { alignItems: 'center', aspectRatio: 1, borderRadius: 10, justifyContent: 'center', width: '14.2857%' }, dayCellSelected: { backgroundColor: AppColors.primaryAction }, dayCellText: { color: AppColors.primaryText, fontSize: 12, fontWeight: '700' }, dayCellTextSelected: { fontWeight: '900' }, timePicker: { alignItems: 'center', flexDirection: 'row', justifyContent: 'center', marginTop: 16 }, timeColumn: { alignItems: 'center', width: 76 }, timeLabel: { color: '#7A8A7B', fontSize: 10, fontWeight: '800', marginBottom: 5 }, timeAdjustButton: { alignItems: 'center', backgroundColor: AppColors.primarySurface, borderRadius: 10, height: 32, justifyContent: 'center', width: 48 }, timeAdjustText: { color: AppColors.primaryText, fontSize: 16, fontWeight: '900' }, timeValue: { color: AppColors.primaryText, fontSize: 26, fontWeight: '900', marginVertical: 5 }, timeDivider: { color: AppColors.primaryText, fontSize: 24, fontWeight: '900', marginTop: 18 }, resetButton: { alignItems: 'center', backgroundColor: '#F0E9D9', borderRadius: 13, justifyContent: 'center', paddingHorizontal: 14, paddingVertical: 12 }, resetButtonText: { color: '#76583F', fontSize: 12, fontWeight: '800' }, floatingTop: { alignItems: 'center', backgroundColor: AppColors.primaryAction, borderRadius: 22, bottom: 23, elevation: 4, paddingHorizontal: 14, paddingVertical: 11, position: 'absolute', right: 18, shadowColor: AppColors.primaryBorder, shadowOffset: { height: 3, width: 0 }, shadowOpacity: 0.2, shadowRadius: 6 }, floatingTopText: { color: AppColors.primaryText, fontSize: 11, fontWeight: '800' }, modalBackdrop: { backgroundColor: 'rgba(70, 84, 89, 0.28)', flex: 1, justifyContent: 'flex-end' }, drawer: { backgroundColor: AppColors.background, borderTopLeftRadius: 28, borderTopRightRadius: 28, minHeight: '78%', padding: 21 }, drawerHeader: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, drawerKicker: { color: AppColors.primaryText, fontSize: 10, fontWeight: '800', letterSpacing: 1.5 }, closeText: { color: AppColors.primaryText, fontSize: 28 }, drawerTitle: { color: AppColors.primaryText, fontSize: 27, fontWeight: '800', marginTop: 9 }, passportCard: { backgroundColor: AppColors.primaryAction, borderRadius: 19, marginTop: 17, padding: 17 }, passportLabel: { color: AppColors.primarySoft, fontSize: 10, marginTop: 7 }, passportValue: { color: AppColors.primaryText, fontSize: 14, fontWeight: '800', marginTop: 3 }, drawerAction: { alignItems: 'center', backgroundColor: '#FFF', borderBottomColor: '#EDF1EB', borderBottomWidth: 1, flexDirection: 'row', justifyContent: 'space-between', minHeight: 57, paddingHorizontal: 14 }, drawerActionText: { color: AppColors.primaryText, fontSize: 12, fontWeight: '800' }, drawerMuted: { color: '#687A80', fontSize: 12, fontWeight: '700' }, drawerBadge: { backgroundColor: '#F0E9D9', borderRadius: 9, color: '#9B795B', fontSize: 9, fontWeight: '800', overflow: 'hidden', paddingHorizontal: 7, paddingVertical: 5 }, bottomSheet: { backgroundColor: AppColors.background, borderTopLeftRadius: 25, borderTopRightRadius: 25, maxHeight: '82%', padding: 21 }, sheetTitle: { color: AppColors.primaryText, fontSize: 20, fontWeight: '800', marginBottom: 8 }, npcModalHint: { color: '#687A80', fontSize: 11, lineHeight: 17, marginBottom: 8 }, optionGroupTitle: { color: '#778677', fontSize: 10, fontWeight: '900', marginTop: 12 }, optionRow: { alignItems: 'center', borderBottomColor: '#E7ECE4', borderBottomWidth: 1, flexDirection: 'row', minHeight: 48 }, optionRowSelected: { backgroundColor: '#F7FAF2' }, optionText: { color: AppColors.primaryText, flex: 1, fontSize: 13, fontWeight: '700', marginLeft: 10 }, optionCheck: { color: AppColors.primaryText, fontSize: 16, fontWeight: '900', width: 22 }, cancelButton: { alignItems: 'center', backgroundColor: AppColors.primarySurface, borderRadius: 13, justifyContent: 'center', paddingHorizontal: 14, paddingVertical: 12 }, cancelButtonText: { color: AppColors.primaryText, fontSize: 12, fontWeight: '800' }, modalLabel: { color: '#687A80', fontSize: 11, fontWeight: '800', marginBottom: 5, marginTop: 10 }, modalInput: { backgroundColor: '#FFF', borderColor: '#DDE6DB', borderRadius: 12, borderWidth: 1, color: AppColors.primaryText, fontSize: 14, paddingHorizontal: 12, paddingVertical: 11 }, modalActions: { flexDirection: 'row', gap: 8, justifyContent: 'flex-end', marginTop: 18 }, deleteButton: { alignItems: 'center', backgroundColor: '#F5E1DE', borderRadius: 13, justifyContent: 'center', paddingHorizontal: 14, paddingVertical: 12 }, deleteButtonText: { color: '#B15F56', fontSize: 12, fontWeight: '800' }, saveButton: { alignItems: 'center', backgroundColor: AppColors.primaryAction, borderRadius: 13, justifyContent: 'center', paddingHorizontal: 19, paddingVertical: 12 }, saveButtonText: { color: AppColors.primaryText, fontSize: 12, fontWeight: '800' }, emptyContainer: { alignItems: 'center', backgroundColor: AppColors.background, flex: 1, justifyContent: 'center', padding: 24 }, emptyTitle: { color: AppColors.primaryText, fontSize: 22, fontWeight: '800' }, emptyDescription: { color: '#788077', fontSize: 14, marginTop: 8 },
});

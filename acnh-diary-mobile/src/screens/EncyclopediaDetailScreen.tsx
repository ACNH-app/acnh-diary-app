...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#29382C', fontSize: 25, fontWeight: '800', marginTop: 3 },
  ...
  heroCopy: { flex: 1 },
  itemName: { color: '#29382C', fontSize: 25, fontWeight: '800', lineHeight: 31 },
  itemCategory: { color: '#5D7B60', fontSize: 12, fontWeight: '700', marginTop: 18 },
  statusPanel: { backgroundColor: '#E6F0DF', borderRadius: 22, marginBottom: 14, padding: 18 },
  panelEyebrow: { color: '#6F8A6B', fontSize: 10, fontWeight: '800', letterSpacing: 1.3 },
  panelTitle: { color: '#2E4834', fontSize: 18, fontWeight: '800', marginTop: 4 },
  statusGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 14 },
  statusCard: { alignItems: 'center', backgroundColor: '#F4F8F0', borderColor: '#D8E5D2', borderRadius: 15, borderWidth: 1, minWidth: '30%', paddingHorizontal: 8, paddingVertical: 10 },
  statusText: { color: '#526354', fontSize: 11, fontWeight: '700', marginTop: 3 },
  statusValue: { color: '#8B978C', fontSize: 10, marginTop: 3 },
  monthBanner: { alignItems: 'center', backgroundColor: '#31573D', borderRadius: 22, flexDirection: 'row', justifyContent: 'space-between', marginBottom: 14, padding: 18 },
  monthBannerCopy: { flex: 1 },
  monthStatus: { color: '#FFF', fontSize: 18, fontWeight: '800', marginTop: 5 },
  monthDetail: { color: '#CFE2C8', fontSize: 12, marginTop: 5 },
  newBadge: { backgroundColor: '#D6EBAE', borderRadius: 14, color: '#31573D', fontSize: 11, fontWeight: '900', overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 7 },
  section: { backgroundColor: '#FFF', borderColor: '#E4E9E0', borderRadius: 20, borderWidth: 1, marginBottom: 14, padding: 18 },
  sectionTitle: { color: '#314A36', fontSize: 18, fontWeight: '800', marginBottom: 12 },
  sectionBody: { gap: 0 },
  ...
  infoValue: { color: '#35483A', flex: 1, fontSize: 13, fontWeight: '700', textAlign: 'right' },
  ...
  infoChipActive: { backgroundColor: '#E1F0DF', color: '#397348' },
  quote: { color: '#526A57', fontSize: 14, fontStyle: 'italic', lineHeight: 23 },

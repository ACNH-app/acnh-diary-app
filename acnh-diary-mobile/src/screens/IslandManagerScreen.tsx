...
const styles = StyleSheet.create({
  ...
  addButton: { backgroundColor: AppColors.primaryAction, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 9 },
  addButtonText: { color: AppColors.primaryText, fontSize: 12, fontWeight: '800' },
  sectionTitle: { color: AppColors.primaryText, fontSize: 18, fontWeight: '800' },
  ...
  islandMark: { alignItems: 'center', backgroundColor: AppColors.primarySurface, borderRadius: 16, height: 38, justifyContent: 'center', width: 38 },
  islandMarkText: { color: AppColors.primaryText, fontSize: 17 },
  islandCopy: { flex: 1, marginLeft: 10 },
  islandName: { color: AppColors.primaryText, fontSize: 14, fontWeight: '800' },
  islandMeta: { color: '#89968B', fontSize: 10, marginTop: 3 },
  rowAction: { paddingHorizontal: 5, paddingVertical: 8 },
  rowActionText: { color: AppColors.primaryText, fontSize: 11, fontWeight: '800' },
  ...
  cancelText: { color: AppColors.primaryText, fontSize: 11, fontWeight: '800' },
  ...
  input: { borderBottomColor: AppColors.primaryBorder, borderBottomWidth: 1, color: AppColors.primaryText, fontSize: 14, paddingBottom: 8, paddingTop: 0 },
  inlineRow: { flexDirection: 'row', gap: 12 },
  choiceRow: { flexDirection: 'row', gap: 8, marginBottom: 14 },
  choice: { backgroundColor: AppColors.primarySurface, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 9 },
  choiceActive: { backgroundColor: AppColors.primaryAction },
  choiceText: { color: '#718074', fontSize: 12, fontWeight: '700' },
  choiceTextActive: { color: AppColors.primaryText },
  error: { color: '#B75F55', fontSize: 11, lineHeight: 17, marginBottom: 10 },
  saveButton: { alignItems: 'center', backgroundColor: AppColors.primaryAction, borderRadius: 14, paddingVertical: 13 },
  saveButtonText: { color: AppColors.primaryText, fontSize: 13, fontWeight: '800' },
});
